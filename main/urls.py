...
from main.views import register , decrement_product, add_product, remove_product, get_product_json,add_product_ajax
from main.views import login_user , create_product_flutter
